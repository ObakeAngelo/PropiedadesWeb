    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_propiedad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.historial_propiedad')),
                ('rut_arrendatario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.arrendatario')),
                ('rut_empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
